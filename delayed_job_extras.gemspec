...
Gem::Specification.new do |s|
  ...
  s.version = "0.9.0.20091004190556"
  ...
  s.files = ["lib/delayed_job_extras/action_mailer.rb", "lib/delayed_job_extras/extras.rb", "lib/delayed_job_extras/hoptoad.rb", "lib/delayed_job_extras/is_paranoid.rb", "lib/delayed_job_extras/job.rb", "lib/delayed_job_extras/performable_method.rb", "lib/delayed_job_extras/worker.rb", "lib/delayed_job_extras.rb", "lib/delayed_job_test_enhancements.rb", "README", "LICENSE", "generators/dj_extras_generator.rb", "generators/templates/migrations/001_add_delayed_job_extras.rb", "generators/templates/migrations/002_add_more_time_columns_to_dj.rb", "generators/templates/migrations/003_add_indexes_to_dj.rb"]
  s.homepage = %q{}
  s.require_paths = ["lib"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<markbates-split_logger>, [">= 0"])
    else
      s.add_dependency(%q<markbates-split_logger>, [">= 0"])
    end
  else
    s.add_dependency(%q<markbates-split_logger>, [">= 0"])
  end
